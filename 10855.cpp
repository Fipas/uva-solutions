...
int main() {
	...
	while (cin >> N >> n && N && n) {
		char bigger[N][N];
		char s1[n][n], s2[n][n], s3[n][n], s4[n][n];
		int c;
		...
		for (int i = 0; i < N; i++) {
			for (int j = 0; j < N; j++) {
				int hits = 0;
				if (bigger[i][j] == s1[0][0]) {
					for (int k = 0; k < n; k++) {
						for (int l = 0; l < n; l++) {
							if (i + k < N && j + l < N && s1[k][l] == bigger[i + k][j + l])
								hits++;
							else
								break;
						}
		...
		for (int i = 0; i < N; i++) {
			for (int j = 0; j < N; j++) {
				int hits = 0;
				if (bigger[i][j] == s2[0][0]) {
					for (int k = 0; k < n; k++) {
						for (int l = 0; l < n; l++) {
							if (i + k < N && j + l < N && s2[k][l] == bigger[i + k][j + l])
								hits++;
							else
								break;
						}
		...
		for (int i = 0; i < N; i++) {
			for (int j = 0; j < N; j++) {
				int hits = 0;
				if (bigger[i][j] == s3[0][0]) {
					for (int k = 0; k < n; k++) {
						for (int l = 0; l < n; l++) {
							if (i + k < N && j + l < N && s3[k][l] == bigger[i + k][j + l])
								hits++;
							else
								break;
						}
		...
		for (int i = 0; i < N; i++) {
			for (int j = 0; j < N; j++) {
				int hits = 0;
				if (bigger[i][j] == s4[0][0]) {
					for (int k = 0; k < n; k++) {
						for (int l = 0; l < n; l++) {
							if (i + k < N && j + l < N && s4[k][l] == bigger[i + k][j + l])
								hits++;
							else
								break;
						}
