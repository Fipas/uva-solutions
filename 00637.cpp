	...
	while (n) {
		...
		if (n <= 3) {
			...
			for (int i = 1; i <= ceil((double) n / 4); i++) {
				if (i == 1) {
					if (n % 4 == 0) {
						cout << "Sheet " << i << ", front: " << end << ", " << start << endl;
						end--;
						start++;
						cout << "Sheet " << i << ", back : " << start << ", " << end << endl;
						end--;
						start++;
					}

					if (n % 4 == 1 || n % 4 == 2)  {
						cout << "Sheet " << i << ", front: Blank, " << start << endl;
						start++;
						cout << "Sheet " << i << ", back : " << start << ", Blank\n";
						start++;
					}
