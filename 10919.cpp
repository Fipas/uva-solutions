...
int main() {
	...
	int coursesTaken, categories;

	while (cin >> coursesTaken >> categories) {
		set<string> courses;
		string course;
		...
		for (int i = 0; i < categories; i++) {
			int coursesCategory, minNumber, takenCategory = 0;
			cin >> coursesCategory >> minNumber;

			for (int j = 0; j < coursesCategory; j++) {
				cin >> course;
